...
CREATE TABLE IF NOT EXISTS projects (
  ...
  search_aliases jsonb NOT NULL DEFAULT '[]'::jsonb CHECK (jsonb_typeof(search_aliases) = 'array'),
  age_rating text NOT NULL DEFAULT 'GENERAL' CHECK (age_rating IN ('GENERAL','AGE_13','AGE_16','AGE_18')),
  content_warnings jsonb NOT NULL DEFAULT '[]'::jsonb CHECK (jsonb_typeof(content_warnings) = 'array'),
