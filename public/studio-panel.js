...
function openProjectEditor(project) {
  ...
  const managed = `<div class="studio-managed-metadata"><strong>Clasificación gestionada por Dubverse</strong><p>La clasificación de edad y las advertencias de contenido sólo pueden modificarse desde Administración.</p></div>`;
