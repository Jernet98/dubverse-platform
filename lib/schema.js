export async function ensureSchema(sql) {
  await sql.transaction([
    ...
    sql`ALTER TABLE episodes ADD COLUMN IF NOT EXISTS archive_playback_mode text NOT NULL DEFAULT 'ARCHIVE_EMBED'`,
    sql`ALTER TABLE episodes ADD COLUMN IF NOT EXISTS archive_native_status text NOT NULL DEFAULT 'UNVERIFIED'`,
    sql`ALTER TABLE episodes ADD COLUMN IF NOT EXISTS archive_native_url text`,
    sql`ALTER TABLE episodes ADD COLUMN IF NOT EXISTS archive_native_verified_at timestamptz`,
    sql`ALTER TABLE episodes ADD COLUMN IF NOT EXISTS archive_native_verification jsonb`,
