...
export function promotionalMediaPlayback(promo) {
  ...
  if (detected.provider !== 'OTHER' && detected.provider !== 'INVALID') return promotionalMediaPlayback({ provider: detected.provider, url: detected.url, providerIdentifier: detected.providerIdentifier, providerFile: detected.providerFile });
